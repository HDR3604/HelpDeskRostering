...
graph LR
    subgraph "Go Backend (DDD)"
        ...
        subgraph "Domain Layer"
            ...
            STU["Student Domain<br/>Apply · Accept · Reject<br/>Profile Management<br/>Availability"]
            ...
            CONFIG["Scheduler Config Domain<br/>CRUD · Set Default<br/>Constraint Parameters"]
            USER["User Domain<br/>CRUD · Role Management<br/>Admin · Student"]
...
graph TB
    subgraph "React 19 + TanStack Router"
        ...
        subgraph "App Layout (_app) — requireAuth"
            DASH["/ Dashboard<br/>Admin: Charts & Stats<br/>Student: Schedule & Earnings"]
            SCHEDP["/schedule<br/>Schedule List & Management"]
            SCHEDD["/schedule/:id<br/>Schedule Detail"]
...
| **Backend** | Go 1.24, Chi router, Go-Jet v2, Zap logging | 8080 | REST API, business logic, auth |
...
| GET | `/api/v1/schedules/active` | Get active schedules |
...
| POST | `/api/v1/schedules/{id}/notify` | Notify students |
| POST | `/api/v1/schedule-generations/` | Create generation |
