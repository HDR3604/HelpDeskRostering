...
type MockRefreshTokenRepository struct {
	...
	DeleteRevokedBeforeFn func(ctx context.Context, tx *sql.Tx, beforeTime time.Time) (int64, error)
}
...
func (m *MockRefreshTokenRepository) DeleteRevokedBefore(ctx context.Context, tx *sql.Tx, beforeTime time.Time) (int64, error) {
	return m.DeleteRevokedBeforeFn(ctx, tx, beforeTime)
}
