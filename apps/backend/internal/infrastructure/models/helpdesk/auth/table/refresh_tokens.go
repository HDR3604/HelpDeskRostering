...
func newRefreshTokensTableImpl(schemaName, tableName, alias string) refreshTokensTable {
	var (
		...
		allColumns       = postgres.ColumnList{IDColumn, UserIDColumn, TokenHashColumn, ExpiresAtColumn, RevokedAtColumn, CreatedAtColumn, ReplacedByColumn}
		mutableColumns   = postgres.ColumnList{UserIDColumn, TokenHashColumn, ExpiresAtColumn, RevokedAtColumn, CreatedAtColumn, ReplacedByColumn}
