...
export async function simulateTranscriptExtraction(
    ...
    return {
        ...
        courses: [
            ...
            {
                courseCode: 'INFO1601',
                courseName: 'Introduction to WWW Programming',
                grade: 'A',
            },
            {
                courseCode: 'MATH1115',
                courseName: 'Fundamental Mathematics for General Sciences',
                grade: 'B',
            },
            {
                courseCode: 'MATH1140',
                courseName: 'Introductory Linear Algebra & Analytic Geometry',
                grade: 'C+',
            },
            {
                courseCode: 'MATH2250',
