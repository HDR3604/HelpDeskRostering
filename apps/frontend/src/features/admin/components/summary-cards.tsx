    ...
    const cards: StatCard[] = [
        ...
        },
        {
            ...
            trend:
                pendingCount > 0
                    ? {
                          value: `${pendingCount} need${pendingCount === 1 ? 's' : ''} action`,
                          direction: 'neutral',
                      }
        ...
        },
        {
            ...
            trend: {
                value: `${totalCount > 0 ? Math.round((acceptedCount / totalCount) * 100) : 0}% acceptance rate`,
                direction: 'up',
            },
        },
        {
            ...
            trend: {
                value: `of ${acceptedCount} accepted`,
                direction:
                    scheduledThisWeekCount >= acceptedCount ? 'up' : 'neutral',
            },
        },
    ]
