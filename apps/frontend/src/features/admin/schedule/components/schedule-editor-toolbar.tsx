                ...
                <div className="flex items-start gap-2 lg:gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        <div className="flex items-center gap-2 flex-wrap">
                            {isLocked ? (
                                <span className="text-xl lg:text-2xl font-bold tracking-tight truncate text-left">
                                    {scheduleTitle}
                                </span>
                            ) : (
                                <button
                            ...
                            <Badge
                                className={cn(
                                    STATUS_BADGE[scheduleStatus].className,
                        ...
                        <p className="mt-0.5 text-sm text-muted-foreground truncate">
                            {!isLocked && (
                                <span className="hidden lg:inline">
                                    Drag and drop students to assign shifts
                                    ·{' '}
                                </span>
                            )}
                            {dateRange}
