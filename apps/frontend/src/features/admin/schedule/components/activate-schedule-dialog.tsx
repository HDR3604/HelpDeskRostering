...
export function ActivateScheduleDialog({
    open,
    onOpenChange,
    scheduleTitle,
    onConfirm,
}: ActivateScheduleDialogProps) {
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        ...
                        the current active schedule. Any previously active
                    ...
                    >
                        ...
                        <label className="flex items-start gap-3 rounded-lg border px-4 py-3 cursor-pointer has-[[data-state=checked]]:border-primary has-[[data-state=checked]]:bg-primary/5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">
                                    The schedule will be activated silently.
                                </p>
                            </div>
                        </label>
                    </RadioGroup>
