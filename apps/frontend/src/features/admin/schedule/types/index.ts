...
export const STUDENT_COLORS = [
    {
        ...
        chip: 'bg-blue-500/15 text-blue-600 dark:text-blue-400 border-l-blue-500',
    },
    {
        bg: 'bg-emerald-100 dark:bg-emerald-500/20',
        dot: 'bg-emerald-500',
        text: 'text-emerald-600 dark:text-emerald-400',
        chip: 'bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border-l-emerald-500',
    },
    {
        bg: 'bg-violet-100 dark:bg-violet-500/20',
        dot: 'bg-violet-500',
        text: 'text-violet-600 dark:text-violet-400',
        chip: 'bg-violet-500/15 text-violet-600 dark:text-violet-400 border-l-violet-500',
    },
    {
        bg: 'bg-rose-100 dark:bg-rose-500/20',
        dot: 'bg-rose-500',
        text: 'text-rose-600 dark:text-rose-400',
        chip: 'bg-rose-500/15 text-rose-600 dark:text-rose-400 border-l-rose-500',
    },
    {
        bg: 'bg-amber-100 dark:bg-amber-500/20',
        dot: 'bg-amber-500',
        text: 'text-amber-600 dark:text-amber-400',
        chip: 'bg-amber-500/15 text-amber-600 dark:text-amber-400 border-l-amber-500',
    },
    {
        bg: 'bg-teal-100 dark:bg-teal-500/20',
        dot: 'bg-teal-500',
        text: 'text-teal-600 dark:text-teal-400',
        chip: 'bg-teal-500/15 text-teal-600 dark:text-teal-400 border-l-teal-500',
    },
    {
        bg: 'bg-pink-100 dark:bg-pink-500/20',
        dot: 'bg-pink-500',
        text: 'text-pink-600 dark:text-pink-400',
        chip: 'bg-pink-500/15 text-pink-600 dark:text-pink-400 border-l-pink-500',
    },
    {
        bg: 'bg-sky-100 dark:bg-sky-500/20',
        dot: 'bg-sky-500',
        text: 'text-sky-600 dark:text-sky-400',
        chip: 'bg-sky-500/15 text-sky-600 dark:text-sky-400 border-l-sky-500',
    },
]
