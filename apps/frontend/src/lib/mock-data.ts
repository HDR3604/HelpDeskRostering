...
export const MOCK_STUDENTS: Student[] = [
    {
        ...
        transcript_metadata: {
            ...
            last_name: 'Doe',
            student_id: '816012345',
            current_programme: 'BSc Computer Science',
            major: 'Computer Science',
            current_term: 'Semester 2',
            current_year: 3,
            overall_gpa: 3.72,
            degree_gpa: 3.85,
            courses: [
                { code: 'COMP2611', title: 'Data Structures', grade: 'A' },
                {
                    code: 'COMP2605',
                ...
                { code: 'INFO3604', title: 'Project', grade: null },
            ],
        },
        availability: {
            '0': [8, 9, 10, 11],
    ...
    },
    {
        ...
        transcript_metadata: {
            ...
            last_name: 'Smith',
            student_id: '816023456',
            current_programme: 'BSc Information Technology',
            ...
            degree_gpa: 3.5,
            courses: [
                { code: 'COMP2611', title: 'Data Structures', grade: 'B+' },
                {
                    code: 'INFO2604',
    ...
    },
    {
        ...
        first_name: 'Aisha',
        last_name: 'Kumar',
        phone_number: '+18681112233',
        transcript_metadata: {
            first_name: 'Aisha',
            last_name: 'Kumar',
            student_id: '816034567',
            current_programme: 'BSc Computer Science (Special)',
            major: 'Computer Science',
            current_term: 'Semester 2',
            current_year: 3,
            overall_gpa: 3.91,
...
export const MOCK_ACTIVE_SCHEDULE: ScheduleResponse = {
    ...
    assignments: [
        ...
        ...[8, 9, 10].map((h) => ({
            assistant_id: '816012345',
            shift_id: shiftId(0, h),
            day_of_week: 0,
...
// Build a student name map from Student[]
