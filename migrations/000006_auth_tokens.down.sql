...
DROP INDEX IF EXISTS idx_auth_tokens_type;

ALTER TABLE "auth"."auth_tokens" DROP COLUMN "type";

ALTER INDEX idx_auth_tokens_token_hash RENAME TO idx_email_verifications_token_hash;
ALTER INDEX idx_auth_tokens_user_id RENAME TO idx_email_verifications_user_id;
